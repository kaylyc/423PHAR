...
ggplot(df_1 %>% 
  filter(good_students), aes(x = intelligence, y = diligence.)
       ) +
  geom_point () +
...
```{r}
g <- dagitty("dag {
aptitude [outcome,pos="1.000,2.000"]
diligence [exposure,pos="3.000,2.000"]
intelligence [selected,pos="0.000,1.000"]
diligence -> aptitude
